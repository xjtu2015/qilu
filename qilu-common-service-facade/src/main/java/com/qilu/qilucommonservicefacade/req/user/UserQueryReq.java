package com.qilu.qilucommonservicefacade.req.user;

import com.qilu.qilucommonservicefacade.req.QueryReq;
...
public class UserQueryReq extends QueryReq {
    ...
    /** 根据注册时间排序 {@link com.qilu.qilucommonservicefacade.enumeration} */
